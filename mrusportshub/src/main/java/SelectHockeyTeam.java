...
@WebServlet("/HockeyTeamServlet")
public class SelectHockeyTeam extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getRequestDispatcher("/select-hockey-team.jsp").forward(request, response);
    }
    ...
    private void insertPlayer(String teamName, String playerName, String playerPosition, String teamType, int matchId) {
        ...
        try {
            ...
            String sql= "INSERT INTO selectedhockeyteam (team_name, player_name, player_position, team_type, match_id) VALUES (?, ?, ?, ?, ?)";
