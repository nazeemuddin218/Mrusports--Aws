...
<html lang="en">
  <head>
    ...
    <title>MRU SPORTS HUB ADMIN</title>
 ...
 <body>
  ...
  <section>
    ...
    <br><br> 
    <div>
    <marquee scrollamount=10><b class="admin">Welcome Admin!!</b></marquee>
    </div>
    <!--banner--> 
   ...
   <h1>Live Matches</h1>
    <div class="liveedit">
        <a href="Match-entry.jsp" class="btn btn-primary">New</a>
        <a href="remove-match.jsp" class="btn btn-danger">Remove</a>
        <a href="live-score.jsp" class="btn btn-primary">Live Score</a>
    </div>
    <div class="live">
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        <div class="match-box">
                            ...
                            <% if ("Cricket".equalsIgnoreCase(sportstype)) { %>
                                <a href="<%= request.getContextPath() %>/CricketTeamServlet?match_id=<%= match_id %>" class="btn btn-primary">Edit team</a>
                            ...
                            <% } else if ("Volleyball".equalsIgnoreCase(sportstype)) { %>
                                <a href="<%= request.getContextPath() %>/VolleyballTeamServlet?match_id=<%= match_id %>" class="btn btn-primary">Edit team</a>
                            ...
                            <% } else if ("Football".equalsIgnoreCase(sportstype)) { %>
                                <a href="<%= request.getContextPath() %>/FootballTeamServlet?match_id=<%= match_id %>" class="btn btn-primary">Edit team</a>
                            ...
                            <% } else if ("Hockey".equalsIgnoreCase(sportstype)) { %>
                                <a href="<%= request.getContextPath() %>/HockeyTeamServlet?match_id=<%= match_id %>" class="btn btn-primary">Edit team</a>
    ...
    <div class="containeer">
        <div class="row padboth">   
            ...
            <div class="items">
             ...
             <div class="inneritem">
                <a href="cricket-team-admin1.jsp"><h3>CRICKET</h3></a>
            ...
            <div class="items">
             ...
             <div class="inneritem">
                <a href="volleyball-team-admin1.jsp"><h3>VOLLEY BALL</h3></a>
            ...
            <div class="items">
                ...
                <div class="inneritem">
                    <a href="football-team-admin1.jsp"><h3>FOOT BALL</h3></a>
            ...
            <div class="items">
              ...
              <div class="inneritem"><br>
                  <a href="hockey-team-admin1.jsp"><h3>HOCKEY</h3></a>
              </div>
            </div>
