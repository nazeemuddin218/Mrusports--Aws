...
<head>
    <meta charset="UTF-8">
    <title>Enter Football Player Details</title>
    <link rel="icon" type="image/png" href="images/mru logo.png">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
</head>
<body>
    <h1>Enter Football Player Details</h1>
    <form action="footballplayer" method="post" enctype="multipart/form-data">
    ...
    <script>
        document.getElementById('playerPosition').addEventListener('change', function(event) {
            ...
            if (value === "Goalkeeper" || value === "Defender" || value === "Midfielder" || value === "Forward") {
